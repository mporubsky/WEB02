...
TRANSLATE = [
    ...
    ("výborná poloha, približne 5 minút od centra", "a good location, roughly five minutes from the centre"),
    ...
    ("rozprávkové popoludnia, spoločné\n        cvičenia detí s&nbsp;mamičkami, kalanetiku pre mamičky (o&nbsp;deti je postarané),\n        tvorivé dielne, výlety, nedeľné veselenie, narodeninové oslavy, odborné\n        prednášky a&nbsp;diskusie, víkendovú školu angličtiny pre predškolákov,\n        v&nbsp;lete opekačky…",
     "storytelling afternoons, exercise sessions for\n        children and their mothers, callanetics for mothers (with the children looked\n        after), craft workshops, trips, Sunday get-togethers, birthday parties, talks\n        and discussions, a weekend English school for pre-schoolers and barbecues in\n        the summer…"),
    ...
    ("Pripravujeme napríklad:", "We are preparing, among other things:"),
    ...
    ("Rešpektujeme schválený Program pre materské školy SR z&nbsp;roku 1999,\n      a&nbsp;to ako otvorený dokument prezentujúci základné a&nbsp;rámcové smerovanie,\n      dopĺňajúc ho o&nbsp;najnovšie trendy z&nbsp;pedagogického výskumu a&nbsp;praxe\n      u&nbsp;nás i&nbsp;v&nbsp;zahraničí.",
     "We follow the approved Slovak Kindergarten Programme of 1999 as an open\n      document setting out the basic direction, and add to it the newest thinking from\n      research and practice at home and abroad."),
